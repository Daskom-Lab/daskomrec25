<div class="fixed hidden inset-0 flex items-center justify-center text-primary font-crimson-text bg-BlackLayer" id="popupShift">
    ...
    <div class="absolute w-[300px] sm:w-[500px] mx-10 sm:mx-36">
        <span onclick="hideShift()"
            ...
            <img src="assets/Close Button.png" alt="Close" class="w-[30px] xs:w-[40px] lg:w-[70px] md:w-[60px] transition-all duration-300 ease-in-out transform hover:scale-105 active:scale-95 list-none hover:brightness-110  cursor-Wand">
        </span>
        ...
        <div class="mt-4 sm:mt-8 lg:mt-10 md:mt-10 space-x-2">
            <button class="relative text-primary transition-all duration-300 ease-in-out transform hover:scale-105 hover:brightness-125 active:scale-95 list-none cursor-Wand">
                ...
                <p class="absolute inset-0 flex items-center justify-center text-md lg:text-xl md:text-xl font-bold cursor-Wand">Yes</p>
            </button>
            <button class="relative text-primary transition-all duration-300 ease-in-out transform hover:scale-105 hover:brightness-125 active:scale-95 list-none cursor-Wand">
                <img src="assets/Button Pink.png" alt="No" class="w-[80px] xs:w-[100px] lg:w-[180px] md:w-[180px] sm:w-[150px] cursor-Wand">
